...
session_set_cookie_params(36000);
 ...
 ?>
 <?php 
    $sql = 'SELECT * FROM certificaciones ORDER BY id DESC';
                                ...
                                <div class="table-responsive">
                                    <table class="display table table-striped table-bordered" id="zero_configuration_table" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Nombres y/o Razon Social</th>
                                                <th>Documento/ y/o NIT</th>
                                        ...
                                        <tbody>
                                            <?php foreach ($rows as $key => $value) { ?>
                                                <tr>
                                                    ...
                                                    <td> <a href="../app/controller/archivos/<?php echo $value['certificacion'] ;?>" download="../app/controller/archivos/<?php echo $value['certificacion'] ;?>">Descargar</a> </td>
                                                    <td><a href="../app/controller/archivos/<?php echo $value['anexo'] ;?>" download="../app/controller/archivos/<?php echo $value['anexo'] ;?>">Descargar</a> </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                        <tfoot>
