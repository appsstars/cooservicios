 ...
 <?php 
  ...
  <?php 
    if(!empty($_POST['titulo'])){
        ...
        if(move_uploaded_file($guardado, '../img/noticias/'.$nombre)){}    
    
        $sql = 'INSERT INTO noticias (titulo, descripcion, img) VALUES ("'.$_POST['titulo'].'","'.$_POST['descripcion'].'","'.$data['archivo'].'")';
        $query = mysqli_query($conexion, $sql);
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="card text-left">
                            <div class="card-body">
                                ...
                                <h4 class="card-title mb-3">Documentos</h4>
                                <a href="#create-noticia" data-toggle="modal" class="btn btn-primary pull-right">publicar</a>
                                <p>Certicaciones bancarias y anexos de los asociados.</p> 
                                        ...
                                        <tbody>
                                            <?php foreach ($rows as $key => $value) { ?>
                                                <tr>
                                                    ...
                                                    <td> <a href="../img/noticias/<?php echo $value['img'] ;?>" download="../img/noticias/<?php echo $value['img'] ;?>">Descargar</a> </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                        <tfoot>
...
<form  method="POST" enctype="multipart/form-data">
    <div class="modal fade" id="create-noticia" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
