    <footer class="footer-content-area ">
        <div class="container">
            <div class="row ">
                <div class="col-12 col-lg-4 col-md-6">
                   <a href="https://api.whatsapp.com/send?phone=573162214729&text=Buen&nbsp;dia&nbsp;me&nbsp;podria&nbsp;ayudar!" target="_blanck" class="appWhatsapp">
                            <img src="img/whatsapp/icon.svg" alt="whatsapp">
                    </a>
                    <div class="footer-copywrite-info">
                        <!-- Copywrite -->
                        <div class="copywrite_text fadeInUp text-center" data-wow-delay="0.2s">
                        ...
                        <!-- Social Icon -->
                        <div class="footer-social-info fadeInUp" data-wow-delay="0.4s" style="margin-top:20px">
                ...
                <div class="col-12 col-lg-3 col-md-6 ">
                    <div class="contact_info_area d-sm-flex justify-content-between">
                        ...
                        <div class="contact_info mt-s text-center fadeInUp" data-wow-delay="0.4s" style="margin-top: 25px">
                            ...
                            <div class="col-md-6">
                                <a href="https://confecoop.coop/home/" target="_black"><img src="img/core-img/confecoop.png" alt=""></a>
                            </div>

                            <div class="col-md-12" style="margin-top: 80px">
                                <p style="color: black; text-align:center;">
                                  <span style="border-bottom: 1px solid black; border-top: 1px solid black">VIGILADO</span>
                                </p>
                                <a href="http://www.supersolidaria.gov.co/" target="_black"><img src="img/core-img/supersolidaria.png" alt=""></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <?php require_once 'modal-servicios.php'; ?>    
    </footer>
    <!-- ##### Footer Area End ##### -->
...
<!-- Mirrored from detotrix.netlify.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Apr 2020 17:42:58 GMT -->
</html>